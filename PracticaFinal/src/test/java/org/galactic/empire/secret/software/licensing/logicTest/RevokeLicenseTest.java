...
class RevokeLicenseTest {
	private LicenseManager myLicenseManager;
	private String jsonFilesFolder;
	
	public RevokeLicenseTest () {
		jsonFilesFolder = System.getProperty("user.dir") + "/JSONFiles/RevokeLicense/";
	...
	void testTodoOK() throws LMException {
		...
		try{
		License obtainedLicense = this.myLicenseManager.RevokeLicense(FilePath);
		}catch(Exception e) {
